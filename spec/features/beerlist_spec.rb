...
describe "Beerlist page" do
    ...
    it "shows beers in correct order by default", js:true do
        visit beerlist_path
    ...
    it "sorts beers correctly when you sort by style", js:true do
        visit beerlist_path
        click_link "Style"
        row1 = find('table').find('tr:nth-child(2)')
        row2 = find('table').find('tr:nth-child(3)')
    ...
    it "sorts beers correctly when you sort by brewery", js:true do
        visit beerlist_path
        click_link "Brewery"
        row1 = find('table').find('tr:nth-child(2)')
        row2 = find('table').find('tr:nth-child(3)')
        ...
        expect(row3).to have_content "Schenkerla"
    end
end
